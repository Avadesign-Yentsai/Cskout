...
public class Search extends Activity 
{
    ...
    public void onCreate(Bundle savedInstanceState) 
	{
        ...
        submit.setOnClickListener(new Button.OnClickListener()
        {
        	...
        	{
        		if((minage.getText().toString()).equals("")||(maxage.getText().toString()).equals(""))
        		{
        		...
        		else
        		{
                    ...
                    intent.setClass(Search.this, Find_Flirts.class);
                    Bundle bundle =new Bundle();
                    bundle.putString("KEY_minage", minage.getText().toString());
                    bundle.putString("KEY_maxage", maxage.getText().toString());
                    bundle.putString("KEY_gender", Sgender);
                    bundle.putString("KEY_interested", Sinterested);
